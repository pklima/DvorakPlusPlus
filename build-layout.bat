...
for /f "skip=2 tokens=2,*" %%a in ('reg query HKLM\SOFTWARE\Wow6432Node\Microsoft\VisualStudio\SxS\VC7 /v 11.0 2^>NUL') do set VCINSTALLDIR=%%b
...
:make
nmake -nologo -fkbddpp.mak "BIN32=%BIN32%" "BIN64=%BIN64%" "NO_GS=%NO_GS%" %*
